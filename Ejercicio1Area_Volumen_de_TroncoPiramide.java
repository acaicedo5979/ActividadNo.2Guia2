...
public class Ejercicio1Area_Volumen_de_TroncoPiramide
{
    public static void main(String[] args) throws IOException { 
        System.out.println("Un tronco de pirámide cuadrangular es una figura geométrica tridimensional,");
        System.out.println("tal como se presenta en la figuraa continuación, donde b es la dimensión del");
        System.out.println("lado del cuadrado superior, y B es la dimensión del lado de cuadrado inferior,");
        System.out.println("y h es la altura del tronco. Escriba programa en Java que solicite la información");
        System.out.println("necesaria para armar un tronco de pirámide, y que calcule y muestre:");
        System.out.println("a. El área del tronco de pirámide");
        System.out.println("b. El volumen del tronco.");
        System.out.println("El siguiente programa permite hallar el area y el volumen de un tronco de piramide");
        System.out.println(" ");
